...
export function ChucuGamePopup() {
  ...
  useEffect(() => {
    ...
    const preventScroll = (e: TouchEvent) => {
      // Allow single touch default behavior only if we really need it, 
      // but here we just prevent all defaults to stop scrolling/pull-to-refresh
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Content Tabs render */}
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-5 scrollbar-thin flex flex-col justify-between max-h-[80vh]">
          {panelTab === 'play' && (
