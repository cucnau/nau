...
export function Reader() {
  ...
  const tChapterSingle = activeCustomTheme === 'homer' ? "tọa độ" : activeCustomTheme === 'giagoan' ? "tài liệu" : activeCustomTheme === 'nhatky' ? "trang" : activeCustomTheme === 'thuytien' ? "khúc" : activeCustomTheme === 'rinhrap' ? "màn" : activeCustomTheme === 'thientai' ? "phó bản" : activeCustomTheme === 'nguoidep' ? "đề bài" : activeCustomTheme === 'thaitu' ? "quyển" : "chương";
  ...
  const tParagraphSubmit = activeCustomTheme === 'homer' ? "Phát" : activeCustomTheme === 'giagoan' ? "Trình" : activeCustomTheme === 'nhatky' ? "Ghi" : activeCustomTheme === 'thuytien' ? "Soi" : activeCustomTheme === 'rinhrap' ? "Phát" : activeCustomTheme === 'nguoidep' ? "Nộp" : activeCustomTheme === 'thaitu' ? "Tấu" : "Gửi";
