...
export function NguoiDepOmYeuTheme(props: ThemeProps) {
  ...
  return (
    <div className="w-full min-h-screen bg-[#808499] text-[#dfdee0] font-lora selection:bg-[#c5ad97]/30 selection:text-[#dfdee0] relative overflow-hidden pb-16">
      ...
      <div className="absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#c5ad97]/20 to-transparent" />
      
      {/* 1. TOP HEADER WITH STATS SUMMARY */}
      <header className="border-b border-[#c5ad97]/25 bg-[#251e23]/95 backdrop-blur-md sticky top-0 z-50 text-[#dfdee0]">
        <div className="max-w-[1400px] mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-4">
          
          <div className="flex items-center gap-3">
            <button 
              onClick={() => navigate('/')}
              className="p-1.5 rounded-lg border border-[#c5ad97]/30 hover:border-[#251e23] text-[#c5ad97] hover:text-[#251e23] hover:bg-[#c5ad97] transition-all bg-[#251e23]"
              title="Quay lại Trang chủ"
            >
              <ArrowLeft className="w-4 h-4" />
            </button>
            <div>
              <span className="text-[10px] font-lora tracking-widest text-[#c5ad97] uppercase flex items-center gap-1.5 font-bold">
                <Clock className="w-3 h-3 text-[#c5ad97] animate-spin-slow" /> HỒ SƠ KHỞI ĐỘNG TRÙNG SINH NĂM 17 TUỔI
              </span>
              <h1 className="font-alegreya text-lg font-bold text-[#dfdee0] leading-tight">
          ...
          <div className="flex items-center gap-4 text-xs">
            {/* Choco display */}
            <div className="hidden sm:flex items-center gap-2 bg-[#604239]/30 border border-[#c5ad97]/20 px-3 py-1.5 rounded-md">
              <Gift className="w-4 h-4 text-[#c5ad97]" />
              <span>Choco của bạn: <strong className="text-[#c5ad97] font-bold">{choco}</strong></span>
            </div>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-md flex items-center gap-1.5 transition-all font-medium text-xs border ${
                savedStories.includes(story.id)
                  ? 'bg-[#c5ad97] border-[#c5ad97] text-[#251e23] font-bold'
                  : 'border-[#c5ad97]/30 text-[#c5ad97] hover:bg-[#c5ad97] hover:text-[#251e23]'
              }`}
            >
            ...
            {story.externalUrl && (
              <a
                ...
                className="px-3 py-1.5 rounded-md flex items-center gap-1.5 bg-[#604239] text-[#dfdee0] border border-[#604239] hover:bg-[#c5ad97] hover:text-[#251e23] transition-all font-medium text-xs"
              >
      ...
      <main className="max-w-[1400px] mx-auto px-4 mt-6 md:mt-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <section className="lg:col-span-3 flex flex-col gap-6 lg:sticky lg:top-[74px]">
            ...
            {/* NOVEL COVER CARD */}
            {story?.coverUrl && (
              <div className="border border-[#c5ad97]/25 bg-[#251e23] p-4 rounded-xl relative shadow-lg flex flex-col items-center">
                <div className="absolute top-2 right-2 border border-[#c5ad97]/30 text-[#c5ad97] text-[8px] font-lora px-1.5 py-0.5 uppercase tracking-widest bg-black/40">
                  MẪU BÌA CHÍNH THỨC
                </div>
                <div className="w-full aspect-[2/3] overflow-hidden rounded-lg border border-[#c5ad97]/20 shadow-inner relative group">
                  <img 
                    src={story.coverUrl} 
                    alt={story.title} 
                ...
                <div className="mt-3 text-center">
                  <span className="text-[10px] font-lora text-[#c5ad97] uppercase tracking-wider">
            ...
            {/* INDICATORS CARD */}
            <div className="border border-[#c5ad97]/25 bg-[#251e23] p-4 rounded-xl relative shadow-lg text-[#dfdee0]">
              <div className="absolute top-1 right-2 p-1 text-[#c5ad97]/20 font-alegreya text-3xl font-bold select-none pointer-events-none">
                35.8°C
              </div>
              <h2 className="text-xs font-lora tracking-widest text-[#c5ad97] uppercase border-b border-[#604239]/40 pb-2 mb-4 flex items-center gap-2 font-bold">
                <Heart className="w-3.5 h-3.5 text-[#c5ad97] animate-pulse" /> CHỈ SỐ SINH MỆNH
              </h2>
              
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-[#dfdee0]/70 font-lora">Nhịp tim (Heart Rate):</span>
                  <span className="text-sm font-lora font-bold text-[#dfdee0] flex items-center gap-1">
                ...
                <div className="flex items-center justify-between mt-1">
                  <span className="text-xs text-[#dfdee0]/70 font-lora">Thân nhiệt (Body Temp):</span>
                  <span className="text-xs font-lora font-bold text-[#dfdee0]">{bodyTemp.toFixed(1)}°C</span>
                </div>
                
                <div className="flex items-center justify-between mt-1">
                  <span className="text-xs text-[#dfdee0]/70 font-lora">Dược phẩm (Medicine):</span>
                  <span className="text-xs font-lora font-bold text-[#c5ad97]">{medPills} viên</span>
                </div>

                <div className="flex items-center justify-between">
                  <span className="text-xs text-[#dfdee0]/70 font-lora">Chén trà hoa cúc:</span>
                  <span className="text-xs font-lora font-bold text-[#c5ad97]">{teaTemp}°C</span>
                </div>
              </div>

              {/* ACTION BUTTONS (Easter eggs!) */}
              <div className="grid grid-cols-2 gap-2 mt-4 pt-3 border-t border-[#604239]/40">
                <button
                  onClick={handleTakeMedicine}
                  className="px-2 py-1.5 text-[10px] font-bold font-lora text-center border border-[#c5ad97]/40 bg-[#c5ad97]/10 hover:bg-[#c5ad97] hover:text-[#251e23] transition-all uppercase rounded text-[#c5ad97]"
                >
                  Uống thuốc
                </button>
                <button
                  ...
                  disabled={isBrewing}
                  className="px-2 py-1.5 text-[10px] font-bold font-lora text-center border border-[#c5ad97]/30 hover:border-[#dfdee0] bg-[#604239]/20 transition-all uppercase rounded text-[#c5ad97] disabled:opacity-40"
                >
                  {isBrewing ? "Đang sắc..." : "Sắc thuốc"}
                </button>
                <button
                  onClick={handleBlowTea}
                  className="px-2 py-1.5 text-[10px] font-bold font-lora text-center border border-[#c5ad97]/30 hover:border-[#dfdee0] bg-[#604239]/20 transition-all uppercase rounded text-[#dfdee0]"
                >
                  Thổi trà
                </button>
                <button
            ...
            <div className="border border-[#c5ad97]/25 bg-[#251e23] p-4 rounded-xl relative shadow-lg text-[#dfdee0]">
              <h2 className="text-xs font-lora tracking-widest text-[#c5ad97] uppercase border-b border-[#604239]/40 pb-2 mb-3 flex items-center gap-2 font-bold">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-2.5 rounded border transition-all text-xs flex flex-col gap-1 ${
                      selectedTarget === t.id
                        ...
                        : 'border-[#c5ad97]/10 hover:border-[#c5ad97]/40 bg-[#604239]/10'
                    }`}
                  >
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-[#dfdee0]">{t.name}</span>
                      <span className={`text-[10px] font-lora px-1.5 py-0.5 rounded bg-black/40 ${t.id === 'thamtruc' ? 'text-[#c5ad97]' : 'text-[#dfdee0]/60'}`}>
                        {t.status}
                      </span>
                    </div>
              ...
              {selectedTarget && activeTargetObj && (
                <div className="mt-3 p-3 bg-black/30 border border-[#604239]/40 rounded text-xs leading-relaxed animate-fade-in">
            ...
            {/* REAL-TIME LOG */}
            <div className="border border-[#c5ad97]/25 bg-[#251e23] p-3 rounded-lg text-[11px] font-lora text-[#dfdee0]">
          ...
          <section className="lg:col-span-6 flex flex-col gap-6">
            ...
            <div className="relative border border-[#c5ad97]/25 bg-[#251e23] p-6 md:p-8 rounded-xl overflow-hidden shadow-2xl flex flex-col items-center text-center text-[#dfdee0]">
              <div className="absolute top-2 right-2 border border-[#c5ad97]/30 text-[#c5ad97]/80 text-[10px] font-lora px-2 py-0.5 uppercase tracking-widest bg-black/40 z-10">
                TRÙNG SINH CHI LỘ
              </div>

              {/* Delicate lace-like corners */}
              <div className="absolute top-4 left-4 w-4 h-4 border-t border-l border-[#c5ad97]/25" />
              <div className="absolute bottom-4 right-4 w-4 h-4 border-b border-r border-[#c5ad97]/25" />

              <div className="mb-4">
                <span className="inline-block px-3 py-1 bg-[#604239]/40 border border-[#c5ad97]/30 rounded-full text-xs text-[#c5ad97] font-alegreya italic">
                  Đại học Hoa Hạ • Học bá trùng sinh báo thù
                </span>
              </div>

              <h2 className="font-alegreya text-2xl md:text-3xl lg:text-4xl font-black text-[#dfdee0] tracking-tight leading-tight mb-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full pt-4 border-t border-[#604239]/40 text-xs text-center">
                <div>
                  <span className="block text-[#dfdee0]/50 text-[10px] uppercase font-lora mb-1">Tác giả</span>
                  <span className="font-bold text-[#c5ad97]">{story?.author || "Đang cập nhật"}</span>
                </div>
                <div>
                  <span className="block text-[#dfdee0]/50 text-[10px] uppercase font-lora mb-1">Số chương</span>
                  <span className="font-bold text-[#dfdee0]">{chapters.length} chương</span>
                </div>
                <div>
                  <span className="block text-[#dfdee0]/50 text-[10px] uppercase font-lora mb-1">Chương đọc sớm</span>
                  <span className="font-bold text-[#c5ad97]">
                    {chapters.filter(c => c.isEarlyAccess).length} chương
                  </span>
                </div>
                <div>
                  <span className="block text-[#dfdee0]/50 text-[10px] uppercase font-lora mb-1">Mã tuyển sinh</span>
                  <span className="font-bold text-[#dfdee0] font-lora">华夏-2026</span>
                </div>
              </div>
            </div>

            {/* TAB SELECTOR: CHAPTERS OR COMMENTS */}
            <div className="flex border-b border-[#251e23] gap-1">
              <button
                ...
                className={`flex-1 py-3 text-center text-xs font-lora tracking-widest uppercase transition-all border-b-2 font-bold flex items-center justify-center gap-2 rounded-t-lg ${
                  activeTab === 'chapters'
                    ? 'border-[#c5ad97] text-[#c5ad97] bg-[#251e23]'
                    : 'border-transparent text-[#dfdee0]/70 hover:text-[#c5ad97] hover:bg-[#251e23]/50'
                }`}
              >
            ...
            {activeTab === 'chapters' && (
              <div className="flex flex-col gap-4">
                ...
                {/* Search & Sort Row */}
                <div className="flex items-center justify-between gap-4 flex-wrap bg-[#251e23] p-2.5 border border-[#c5ad97]/25 rounded-lg text-[#dfdee0]">
                  <div className="text-xs text-[#dfdee0]/80 font-lora pl-2">
                    Tổng số: <strong className="text-[#c5ad97]">{chapters.length}</strong> bài ôn luyện
                  </div>
                  
                  <button
                    onClick={() => setChapterSortDesc(!chapterSortDesc)}
                    className="px-3 py-1.5 text-[10px] font-lora uppercase bg-[#604239]/30 border border-[#c5ad97]/30 text-[#c5ad97] rounded hover:bg-[#c5ad97] hover:text-[#251e23] transition-colors font-bold"
                  >
                ...
                {displayedChapters.length === 0 ? (
                  <div className="text-center py-12 border border-dashed border-[#c5ad97]/30 rounded-xl bg-[#251e23]">
                    <p className="text-[#dfdee0]/70 text-sm font-alegreya italic">Đề thi mẫu đang được biên soạn, hãy quay lại sau...</p>
                  </div>
                ) : (
                    ...
                    {displayedChapters.map((chap, i) => {
                      ...
                      return (
                        <button
                          ...
                          className="group text-left p-4 rounded-xl border border-[#c5ad97]/15 hover:border-[#c5ad97]/80 bg-gradient-to-br from-[#251e23] to-[#251e23]/90 hover:from-[#604239]/40 hover:to-[#251e23] transition-all shadow hover:shadow-xl flex flex-col justify-between h-[120px] relative overflow-hidden"
                        >
                          {/* Top Tag row */}
                          <div className="flex justify-between items-start w-full gap-2 z-10">
                            <span className="text-[9px] font-lora text-[#c5ad97] tracking-wider uppercase">
                              MÃ ĐỀ LUYỆN {absoluteIndex.toString().padStart(2, '0')}
                            </span>
                            
                            {isLocked ? (
                              <span className="text-[9px] font-lora px-1.5 py-0.5 rounded bg-[#604239]/50 border border-[#604239] text-[#dfdee0]/70">
                                CHƯA PHÊ DUYỆT
                              </span>
                            ) : isEarly ? (
                              <span className="text-[9px] font-lora px-1.5 py-0.5 rounded bg-[#c5ad97]/20 border border-[#c5ad97]/30 text-[#c5ad97]">
                                ĐỌC SỚM
                              </span>
                            ) : (
                              <span className="text-[9px] font-lora px-1.5 py-0.5 rounded bg-[#604239]/30 border border-[#c5ad97]/20 text-[#c5ad97]">
                                MIỄN PHÍ
                              </span>
                            )}
                          </div>
                          ...
                          <div className="my-2 z-10">
                            <h3 className="font-alegreya text-sm font-bold text-[#dfdee0] group-hover:text-[#c5ad97] transition-colors line-clamp-2">
                              {chap.title}
                            </h3>
                          </div>
                          ...
                          <div className="flex justify-between items-center w-full z-10">
                            <span className="text-[10px] text-[#dfdee0]/60 font-lora">
                ...
                {chapters.length > CHAPTERS_PER_PAGE && (
                  <div className="flex justify-between items-center mt-6 pt-4 border-t border-[#604239]/40">
                    <button
                      onClick={() => setChapterPage(Math.max(0, chapterPage - 1))}
                      disabled={chapterPage === 0}
                      className="px-3 py-1.5 rounded border border-[#c5ad97]/30 text-[#c5ad97] bg-[#251e23] hover:bg-[#604239] hover:text-[#dfdee0] transition-colors disabled:opacity-30 disabled:pointer-events-none text-xs flex items-center gap-1"
                    >
                      <ChevronLeft className="w-4 h-4" /> Trang trước
                    </button>
                    
                    <span className="text-xs font-lora text-[#dfdee0] font-bold">
                      Trang <strong className="text-[#251e23] bg-[#c5ad97] px-2 py-0.5 rounded">{chapterPage + 1}</strong> / {Math.ceil(chapters.length / CHAPTERS_PER_PAGE)}
                    </span>
            ...
            {activeTab === 'comments' && (
              <div className="flex flex-col gap-6">
                ...
                {/* COMMENT BOX */}
                <div className="border border-[#c5ad97]/25 bg-[#251e23] p-4 rounded-xl relative text-[#dfdee0]">
                  <h3 className="text-xs font-lora tracking-widest text-[#c5ad97] uppercase mb-3 flex items-center gap-1.5 font-bold">
                  ...
                  <form onSubmit={handleSendComment} className="flex flex-col gap-3">
                    <textarea
                      ...
                      rows={3}
                      disabled={!isLoggedIn}
                      className="w-full p-3 border border-[#604239]/40 bg-black/25 text-[#dfdee0] placeholder-[#808499] focus:outline-none focus:border-[#c5ad97] rounded-lg text-xs sm:text-sm resize-none transition-all disabled:opacity-40"
                    />
                    
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-lora text-[#dfdee0]/60">
                        {isLoggedIn ? `Đang đăng nhập: ${displayName || "Thành viên"}` : "Kênh ngoại tuyến"}
                      </span>
                      <button
                        type="submit"
                        disabled={submittingComment || !commentText.trim() || !isLoggedIn}
                        className="px-5 py-2 rounded font-bold font-lora tracking-wider bg-[#c5ad97] text-[#251e23] hover:bg-[#dfdee0] transition-colors text-xs uppercase disabled:opacity-40 disabled:cursor-not-allowed"
                      >
                ...
                <div className="flex flex-col gap-4">
                  {comments.length === 0 ? (
                    <div className="text-center py-10 border border-dashed border-[#c5ad97]/30 rounded-xl bg-[#251e23]">
                      <p className="text-[#dfdee0]/70 text-xs font-alegreya italic font-bold">Thương hội chưa có công văn nào. Hãy là người đầu tiên đặt câu hỏi!</p>
                    </div>
                  ) : (
                    <div className="flex flex-col gap-4">
                      {comments.map((comm) => {
                        ...
                        return (
                          <div key={comm.id} className="p-4 border border-[#c5ad97]/20 bg-[#251e23] text-[#dfdee0] rounded-xl relative shadow">
                            ...
                            <div className="flex justify-between items-start gap-4 mb-2">
                              <div className="flex items-center gap-2.5">
                                <UserAvatar 
                                  ...
                                  className="w-8 h-8 rounded-full border border-[#604239]/40"
                                />
                                <div>
                                  <h4 className="text-xs font-bold text-[#c5ad97]">
                                    {comm.displayName || comm.authorName || "Nhà lữ hành ẩn danh"}
                                  </h4>
                                  <span className="text-[9px] font-lora text-[#dfdee0]/50">
                              ...
                              <span className="text-[9px] font-lora text-[#dfdee0]/40 tracking-widest uppercase">
                                #{comm.id?.slice(-4) || "MSG"}
                              </span>
                            </div>
                            ...
                            {comm.replies && comm.replies.length > 0 && (
                              <div className="mt-3.5 pl-11 flex flex-col gap-3 border-l border-[#604239]/40 ml-3.5">
                                    ...
                                    <div key={rep.id || idx} className="text-xs">
                                      <div className="flex items-center gap-2 mb-1">
                                        <UserAvatar 
                                          ...
                                          className="w-5 h-5 rounded-full border border-[#604239]/40"
                                        />
                            ...
                            <div className="mt-2.5 pl-11 flex justify-end">
                              {replyingToId === comm.id ? (
                                <div className="w-full flex flex-col gap-2 bg-black/25 p-2 rounded-lg border border-[#604239]/30">
                                  <textarea
                                    value={replyText}
                                    onChange={(e) => setReplyText(e.target.value)}
                                    placeholder="Nhập phản hồi cố vấn..."
                                    rows={2}
                                    className="w-full p-2 bg-[#251e23]/80 text-xs text-[#dfdee0] placeholder-[#808499] focus:outline-none focus:border-[#c5ad97] border border-[#604239]/40 rounded"
                                  />
                                ...
                                <button
                                  ...
                                  className="text-[10px] font-lora text-[#c5ad97] hover:text-[#dfdee0] flex items-center gap-1"
                                >
          ...
          <section className="lg:col-span-3 flex flex-col gap-6 lg:sticky lg:top-[74px]">
            ...
            {/* EXAM REVISION BOARD */}
            <div className="border border-[#c5ad97]/25 bg-[#251e23] p-4 rounded-xl relative shadow-lg text-[#dfdee0]">
              <h2 className="text-xs font-lora tracking-widest text-[#c5ad97] uppercase border-b border-[#604239]/40 pb-2 mb-3.5 flex items-center gap-2 font-bold">
              ...
              <div className="flex flex-col gap-3 text-xs">
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="font-bold font-lora text-[#dfdee0]">148 <span className="text-[10px] font-normal text-[#dfdee0]/50">/ 150</span></span>
                  </div>
                  <div className="w-full h-1.5 bg-[#604239]/30 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="font-bold font-lora text-[#dfdee0]">135 <span className="text-[10px] font-normal text-[#dfdee0]/50">/ 150</span></span>
                  </div>
                  <div className="w-full h-1.5 bg-[#604239]/30 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="font-bold font-lora text-[#dfdee0]">147 <span className="text-[10px] font-normal text-[#dfdee0]/50">/ 150</span></span>
                  </div>
                  <div className="w-full h-1.5 bg-[#604239]/30 rounded-full overflow-hidden">
                ...
                <div className="mt-2.5 pt-3 border-t border-[#604239]/40 flex justify-between items-center">
                  <span className="text-[#dfdee0]/50 text-[10px] uppercase font-lora">Xếp hạng:</span>
                  <span className="font-bold font-lora text-[#c5ad97] bg-[#c5ad97]/10 px-2 py-0.5 rounded text-[10px] border border-[#c5ad97]/20">
              ...
              <div className="flex flex-col gap-2">
                {schedule.map(item => (
                  <button
                    ...
                    className="w-full text-left flex items-start gap-2.5 p-2 rounded hover:bg-[#604239]/20 transition-all text-xs"
                  >
                    <span className="mt-0.5 text-[#c5ad97]">
                      {item.completed ? (
                        <CheckSquare className="w-4 h-4 text-[#c5ad97]" />
                      ) : (
                        <Square className="w-4 h-4 text-[#604239]" />
                      )}
                    </span>
                    <div className="flex-1">
                      <div className="flex items-center gap-1.5 mb-0.5">
                        <span className="font-lora text-[9px] px-1 py-0.1 bg-black/30 text-[#c5ad97] rounded">
                          {item.time}
                        </span>
                      </div>
            ...
            <div className="border border-[#c5ad97]/25 bg-[#251e23] p-4 rounded-xl relative shadow-lg text-[#dfdee0]">
              <div className="absolute top-2 right-2 border border-[#c5ad97]/30 text-[#c5ad97] text-[9px] font-lora px-1.5 py-0.1 rounded bg-[#c5ad97]/10 flex items-center gap-1">
              ...
              <div className="flex flex-col gap-2.5 text-xs">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold font-lora text-[#c5ad97]">{stockPrice.toFixed(3)} VND</span>
                </div>
                
                <div className="flex items-center justify-between">
                  <span className="text-[#dfdee0]/70">Biến động ngày:</span>
                  <span className={`font-bold font-lora flex items-center ${stockChange >= 0 ? 'text-[#c5ad97]' : 'text-[#dfdee0]/70'}`}>
                    {stockChange >= 0 ? "+" : ""}{stockChange}%
                  </span>
                </div>

                <div className="w-full bg-[#604239]/20 p-2.5 rounded border border-[#604239]/40 text-[#dfdee0]/70 italic mt-1.5">
                  "Ủy thác đầu tư ngầm, thâu tóm cổ phiếu Lâm Thị từ 17 tuổi là quân cờ then chốt."
                </div>

                <button
                  onClick={updateMarketPrice}
                  className="w-full mt-2 py-2 border border-[#c5ad97]/30 hover:border-[#c5ad97] text-xs font-lora text-[#251e23] bg-[#c5ad97] hover:bg-[#dfdee0] transition-all rounded uppercase font-bold"
                >
                  Cập nhật thị trường
                </button>
              </div>
