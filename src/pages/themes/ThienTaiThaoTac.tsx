  ...
  return (
    <div className="min-h-screen bg-[#060406] text-[#d4c6c9] font-sans selection:bg-[#9a858d]/30 selection:text-white pb-20 overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute left-0 right-0 h-[1px] bg-[#9a858d]/20 top-[20%] shadow-[0_0_15px_#9a858d]" />
        <div className="absolute left-0 right-0 h-[1px] bg-[#9a858d]/10 top-[60%]" />
      </div>
      ...
      <div className="max-w-[1200px] mx-auto p-4 md:p-8 relative z-10 flex flex-col gap-12 mt-4 md:mt-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="flex-1 flex flex-col font-mono w-full">
            ...
            <div className="relative border-l-2 border-[#9a858d] pl-5 py-2 mb-8">
